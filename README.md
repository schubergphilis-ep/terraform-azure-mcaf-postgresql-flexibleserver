...
| Name | Description |
|------|-------------|
| <a name="output_administrator_password"></a> [administrator\_password](#output\_administrator\_password) | The generated administrator password. Null when password authentication is disabled. |
